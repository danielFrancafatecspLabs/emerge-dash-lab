    ...
    <div className="min-h-screen bg-gray-50 p-0">
      <div className="w-full max-w-7xl mx-auto py-10 px-8 grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
        <section className="md:col-span-2 mb-8">
          <h1 className="text-5xl font-extrabold text-[#7a0019] mb-4 tracking-tight">
            beOn Labs
          </h1>
          <p className="text-2xl text-gray-700 font-medium mb-2">
            O laboratório de inovação e experimentação da Claro Brasil
          </p>
          <p className="text-lg text-gray-600">
            Conectando diferentes áreas da empresa, cada uma com seu núcleo de
            P&D, para inovação colaborativa e direcionada.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="text-lg text-gray-700 list-disc ml-6 mb-6">
            <li>
              <b>Future Network</b>: Redes do futuro e conectividade avançada
            </li>
            <li>
              <b>AI & ML</b>: Inteligência Artificial e aprendizado de máquina
            </li>
            <li>
              <b>Web 3</b>: Ecossistemas descentralizados e seguros
            </li>
            <li>
              <b>Desafios Tecnológicos</b>: Abordagem inovadora para problemas
              complexos
            </li>
            <li>
        ...
        <section className="md:col-span-2">
          <h2 className="text-3xl font-bold text-[#7a0019] mb-4 flex items-center gap-2">
            <Users className="w-8 h-8" /> Fórum de Tecnologia
          </h2>
          <p className="text-lg text-gray-700 mb-2">
            Acontece a cada 15 dias para apresentar tecnologias desenvolvidas ou
            testadas na empresa, com participação de líderes de TI, Engenharia,
            Operações e outros segmentos.
          </p>
          <a
            href="mailto:daniel.frauches@claro.com.br"
            className="text-[#7a0019] underline font-semibold"
          >
            daniel.frauches@claro.com.br
          </a>
          <span className="block text-gray-600 text-base mt-2">
            Envie uma mensagem para ser adicionado ao invite e fique atualizado
            do futuro da tecnologia na empresa.
          </span>
        </section>
        ...
        <section>
          ...
          <ul className="text-lg text-gray-700 list-disc ml-6 mb-6">
            <li>
              Confira o <b>repositório de Pesquisas</b>
            </li>
            <li>
              <b>Fichas de Experimento</b>
            </li>
            <li>
              <b>Relatórios</b>
            </li>
        ...
        <section className="md:col-span-2 text-center mt-8">
          <span className="inline-block px-8 py-4 rounded-full bg-[#7a0019] text-white text-2xl font-bold shadow-lg tracking-wide">
            Sua ideia pode ganhar vida com o beOn Labs!
          </span>
        </section>
      </div>
    </div>
